	...
	<div class="w3-row-padding w3-margin-bottom" style="margin-top: 10%">
		<div class="w3-half">
			...
			<form method="post" action="ConfirmID_Member" enctype="multipart/form-data" class="w3-container w3-white">
				...
				<input class="w3-input w3-border w3-border-dark-grey w3-round" name="name" type="text" placeholder="Name" required>
				<br>
				<label class="w3-text-dark-grey"><b>이메일</b></label>
				<input class="w3-input w3-border w3-border-dark-grey w3-round" name="email" type="text" placeholder="Email" required>
				<br>
		...
		<div class="w3-half">
			...
			<form method="post" action="ConfirmPWD_Member" enctype="multipart/form-data" class="w3-container w3-white">
				...
				<input class="w3-input w3-border w3-border-dark-grey w3-round" name="empno" type="text" placeholder="Empno" required>
				<br>
				<label class="w3-text-dark-grey"><b>이름</b></label>
				<input class="w3-input w3-border w3-border-dark-grey w3-round" name="name" type="text" placeholder="Name" required>
				<br>
