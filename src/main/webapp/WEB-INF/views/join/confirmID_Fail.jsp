...
<div id="pentext" class="w3-center w3-border-dark-grey w3-display-middle w3-topbar w3-bottombar w3-leftbar w3-rightbar" style="min-width: 300px;">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<img src="/erp/resources/image/unknown.png">
	<h1>확인 실패</h1>
	<h3>입력하신 정보가 일치하지 않습니다.</h3><br>
	<button class="w3-btn w3-border w3-text-dark-grey w3-border-dark-grey w3-round-large w3-small w3-white" onclick="location='/erp/confirmID'"><h4>뒤로가기</h4></button>
	<br><br><br>
</div>
	<div class="w3-row ">
