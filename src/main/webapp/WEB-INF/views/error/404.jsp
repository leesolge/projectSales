...
<div id="pentext" class="w3-center w3-border-dark-grey w3-display-middle w3-topbar w3-bottombar w3-leftbar w3-rightbar" style="min-width: 300px;">
	<br>
	<img src="/erp/resources/image/error404.png" height="150">
	<h1>경고!</h1>
	<h3>페이지를 찾을 수 없습니다.</h3><br>
	<button class="w3-btn w3-border w3-text-dark-grey w3-border-dark-grey w3-round-large w3-small w3-white" onclick="location='/erp/main'"><h4>메인가기</h4></button>
	<br><br><br>
</div>
</body>
</html>