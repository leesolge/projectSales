	...
	<div class="w3-card-2 w3-white w3-round-large w3-centered w3-padding">
		...
		<div align="right">
			<sec:authorize access="hasAnyAuthority('ROLE_ADMIN')">
				<button class="w3-btn w3-border w3-text-blue-grey w3-border-blue-grey w3-round-large w3-small w3-white" onclick="location='/erp/notice/admin/noticeWriteForm'">글쓰기</button>
			</sec:authorize>
		</div>
		...
		<div class="w3-row w3-center">
			<form action="/erp/notice/noticeList" name="search" method="post">
				<input class="w3-border w3-border-blue-grey" type="text" name="word" placeholder="검색어" value="${word}" />
				<button class="w3-border w3-border-blue-grey w3-blue-grey" type="submit"><i class="fa fa-search"></i></button>
			</form>
		</div><br>
